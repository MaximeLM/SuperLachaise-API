...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        setting, created = Setting.objects.get_or_create(key="openstreetmap:auto_apply_modifications")
        setting.value = "false"
        ...
        setting, created = Setting.objects.get_or_create(key="openstreetmap:bounding_box")
        ...
        setting, created = Setting.objects.get_or_create(key="openstreetmap:exclude_ids")
        setting.value = """[{"type": "node", "id": 1688357881}]"""
        setting.description = _("""The OpenStreetMap IDs to exclude from syncing""")
        setting.save()

        setting, created = Setting.objects.get_or_create(key="openstreetmap:synced_tags")
        ...
        setting, created = Setting.objects.get_or_create(key="wikidata:accepted_locations_of_burial")
        ...
        setting, created = Setting.objects.get_or_create(key="wikidata:auto_apply_modifications")
        setting.value = "false"
        setting.description = _("""If set to 'true', new modifications are applied immediately after being created. If set to 'false', a pending modification is created and must be manually accepted.""")
        setting.save()
        
        setting, created = Setting.objects.get_or_create(key="wikimedia_commons:auto_apply_modifications")
        setting.value = "false"
        setting.description = _("""If set to 'true', new modifications are applied immediately after being created. If set to 'false', a pending modification is created and must be manually accepted.""")
        setting.save()
        
        setting, created = Setting.objects.get_or_create(key="wikimedia_commons:synced_instance_of")
        ...
        setting, created = Setting.objects.get_or_create(key="wikimedia_commons:sync_only_main_image")
        setting.value = "true"
        ...
        setting, created = Setting.objects.get_or_create(key="wikimedia_commons:thumbnail_width")
        setting.value = "350"
        setting.description = _("""The thumbnail width to request when syncing Wikimedia Commons files.""")
        setting.save()
        
        setting, created = Setting.objects.get_or_create(key="superlachaise_poi:auto_apply_modifications")
        setting.value = "false"
        setting.description = _("""If set to 'true', new modifications are applied immediately after being created. If set to 'false', a pending modification is created and must be manually accepted.""")
        setting.save()
